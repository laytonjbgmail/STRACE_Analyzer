...
#
#
# TODO: Need to fix final data point for IOPS file - may not want to do final data point
# TODO: Finish matplotlib plotting
# TODO: Add in "per unit" plot files
# TODO: Create generic file output for various data pieces (an eye to multiple files)
# TODO: Add standard deviation computations for write's and read's
#
...
if __name__ == '__main__':
    ...
    for line in open(input_filename,'r').readlines():
        ...
        elapsed_time = junk1[1:(len(junk1)-1)];
        if (debug > 0):
        ...
        if (cmp(cmd, OPEN) == 0):
            ...
            Open_Processing(currentline,Open_obj,IOPS_obj,Open_Filename,OPEN,elapsed_time,
            ...
            Read_Processing(currentline,Read_obj,IOPS_obj,Open_Filename,READ,elapsed_time,
                            LineNum,sec,BeginTime,debug,STRACE_LOG,CmdCounter);
            ...
            Write_Processing(currentline,Write_obj,IOPS_obj,Open_Filename,WRITE,elapsed_time,
                             LineNum,sec,BeginTime,debug,STRACE_LOG,CmdCounter);
            ...
            Close_Processing(currentline,Close_obj,IOPS_obj,Open_Filename,CLOSE,elapsed_time,
                             LineNum,sec,BeginTime,debug,STRACE_LOG,CmdCounter);
            ...
            Lseek_Processing(currentline, Lseek_obj, IOPS_obj, Open_Filename, LSEEK, elapsed_time,
                             LineNum, sec, BeginTime, debug, STRACE_LOG, CmdCounter);
    ...
    print " ";
    print "Number of open files at end of analysis",len(Open_Filename);
    iloop = 0;
    for temp_dict in Open_Filename:
        iloop = iloop + 1;
        print iloop," unit: ",temp_dict["unit"]," filename: ",temp_dict["filename"]
    # end for
    ...
    print "===============";
    print " "
    print "Number of Lines in strace file: ",NumLines
    print " ";
    ...
    print "Total number of IO Functions: ",commify3(IOTime_count);
    ...
    output_str = output_str + "<Strong>Total IO Time for read():</strong> " + junk3a + " seconds &nbsp \n";
    output_str = output_str + "<BR> \n";
    junk4 = "%.4f" % IOTimeSum_Write;
    ...
    # ==================
    # ==================
    currentfigure2 = IOPS_obj.iops_output_stats(f, CmdCounter, BeginTime, EndTime, WRITE, READ, VFLAGS, dirname, currentfigure);
    currentfigure = currentfigure2;
    ...
    if (VFLAGS > 2):
       Individual_plots(f, VFLAGS, currentfigure, BeginTime, EndTime, 
